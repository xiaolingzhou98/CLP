...
def build_dataset(dataset,num_meta):
    ...
    if dataset == 'cifar10':
        ...
        test_dataset = torchvision.datasets.CIFAR10('', train=False, transform=transform_test)
        img_num_list = [num_meta] * 10
        num_classes = 10

    if dataset == 'cifar100':
        train_dataset = torchvision.datasets.CIFAR100(root='', train=True, download=False, transform=transform_train)
        test_dataset = torchvision.datasets.CIFAR100('', train=False, transform=transform_test)
